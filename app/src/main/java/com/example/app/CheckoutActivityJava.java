...
public class CheckoutActivityJava extends AppCompatActivity {
    ...
    private static final String BACKEND_URL = "http://192.168.43.131:4242/";
...
//                stripe.confirmSetupIntent(this, confirmParams);
            ...
            PaymentMethodCreateParams.Card card = cardInputWidget.getPaymentMethodCard();
            //Toast.makeText(this, "Card: "+card.toString(), Toast.LENGTH_SHORT).show();
            EditText emailInput = findViewById(R.id.emailInput);
            ...
            //Toast.makeText(this, "billing: "+billingDetails.toString(), Toast.LENGTH_SHORT).show();
            if (card != null) {
                //payment details card,billing,metadeta
                PaymentMethodCreateParams paymentMethodParams = PaymentMethodCreateParams
                        .create(card, billingDetails);
                //Toast.makeText(this, "pmthdcreateparam: "+paymentMethodParams.toString(), Toast.LENGTH_SHORT).show();
